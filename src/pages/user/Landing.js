		...
		<div>
						...
						<nav class="limiter-menu-desktop container">
							...
							<div class="wrap-icon-header flex-w flex-r-m">
								...
								<a
									...
									data-notify="0"
								>
									<i class="zmdi zmdi-favorite-outline" />
								</a>
							</div>
						</nav>
					</div>
			...
			<section class="section-slide">
				<div class="wrap-slick1">
					<div class="slick1">
						<div class="item-slick1" style={{backgroundImage: "url(assets/images/slide-01.jpg)"}}>
						...
						<div class="item-slick1" style={{backgroundImage: "url(assets/images/slide-02.jpg)"}}>
							<div class="container h-full">
								<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
									<div
										class="layer-slick1 animated visible-false"
						...
						<div class="item-slick1" style={{backgroundImage: "url(assets/images/slide-03.jpg)"}}>
							<div class="container h-full">
								<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
									<div
										class="layer-slick1 animated visible-false"
					...
					<div class="flex-w flex-sb-m p-b-52">
						...
						<div class="flex-w flex-c-m m-tb-10">
							<div class="flex-c-m stext-106 cl6 size-104 bor4 pointer hov-btn3 trans-04 m-r-8 m-tb-4 js-show-filter">
								<i class="icon-filter cl2 m-r-6 fs-15 trans-04 zmdi zmdi-filter-list" />
								<i class="icon-close-filter cl2 m-r-6 fs-15 trans-04 zmdi zmdi-close dis-none" /> Filter
							</div>
							<div class="flex-c-m stext-106 cl6 size-105 bor4 pointer hov-btn3 trans-04 m-tb-4 js-show-search">
								<i class="icon-search cl2 m-r-6 fs-15 trans-04 zmdi zmdi-search" />
								<i class="icon-close-search cl2 m-r-6 fs-15 trans-04 zmdi zmdi-close dis-none" /> Search
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="p-t-40">
						...
						<p class="stext-107 cl6 txt-center">
							...
							template is made with <i class="fa fa-heart-o" aria-hidden="true" /> by{' '}
